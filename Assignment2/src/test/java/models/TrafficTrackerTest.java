...
public class TrafficTrackerTest {
    ...
    public void importCarsCheck() {
        ...
        // Check that proper OrderedLists have been created with a specified sort order
        assertNotNull(tracker.getCars().getSortOrder());
    ...
    public void importVaultCheck() {
        ...
        assertNotNull(trafficTracker.getViolations().getSortOrder());
