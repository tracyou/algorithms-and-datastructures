...
public class WagonTest {
    ...
    public void T10_PartiallyReverseASequenceOfFour() {
        ...
        System.out.println(rev.getSequenceLength());
    ...
    @Test
    /**
    * Checks if the sequence length decreases when a wagon is detached.
    */
    public void T11_CheckSequenceLengthAfterDetach() {
        passengerWagon1.attachTail(passengerWagon2);
        passengerWagon2.attachTail(passengerWagon3);
        passengerWagon3.attachTail(passengerWagon4);

        //detach tail from train
        passengerWagon3.detachTail();

        assertEquals(3, passengerWagon1.getSequenceLength());
    }

    @Test
    /**
     * Checks if the sequence length increases when a wagon is attached.
     */
    public void T12_CheckSequenceLengthAfterAttach() {
        passengerWagon1.attachTail(passengerWagon2);
        passengerWagon2.attachTail(passengerWagon3);
