...
public class Candidate {
    ...
    public boolean equals(Object o) {
        ...
        //the equality criterion to identify unique candidate instances
        return this.getParty().equals(other.getParty()) && this.getFullName().equals(other.getFullName());
    }

    @Override
    public int hashCode() {
        //a hashCode that is consistent with above equality criterion
