...
public class Party {
    ...
    public Candidate addOrGetCandidate(Candidate newCandidate) {
        ...
        if (candidates.add(newCandidate)) {
            return newCandidate; // No duplicate instance found, return the newCandidate itself
        } else {
            // Search for the existing duplicate instance in the set
            for (Candidate existingCandidate : candidates) {
                if (existingCandidate.equals(newCandidate)) {
                    return existingCandidate; // Found duplicate instance, return it
                }
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        // provided the equality criterion to identify unique party instances
        return this.getName().equals(other.getName());
    }

    @Override
    public int hashCode() {
        // provided a hashCode that is consistent with above equality criterion
